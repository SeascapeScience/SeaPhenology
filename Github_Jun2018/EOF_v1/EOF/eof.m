...
% 
%% Example 
% For an in-depth tutorial of how to use this function with climate data, type
% 
%   showdemo eof_documentation
%
%% Author Info 
...
function [e,pc,expvar,L] = mycaleof(M,N)
...
% Covariance Matrix % Was this right??
if n >= p
   R = F' * F;
else 
   R = F * F';
